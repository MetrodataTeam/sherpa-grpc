...
class SenseVoiceConfig(betterproto.Message):
  lang: Optional['SenseVoiceLanguage'] = betterproto.enum_field(
    1, optional=True
  )
  textnorm: Optional['SenseVoiceTextnorm'] = betterproto.enum_field(
    2, optional=True
  )
...
class SherpaServiceBase(ServiceBase):
  ...
  async def __rpc_vad(
    self,
    stream: 'grpclib.server.Stream[Audio, OfflineSpeakerDiarizationResult]',
  ) -> None:
